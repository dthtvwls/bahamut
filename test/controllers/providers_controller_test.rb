...
class ProvidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create provider" do
    assert_difference('Provider.count') do
      post providers_url, params: { provider: { box: @provider.box, name: @provider.name, version_id: @provider.version_id } }
    end
  ...
  test "should update provider" do
    patch provider_url(@provider), params: { provider: { box: @provider.box, name: @provider.name, version_id: @provider.version_id } }
